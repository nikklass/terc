...
class GlobalAltarController extends Controller
{
    ...
    public function index(Request $request, GlobalAltarIndex $globalAltarIndex)
    {
        ...
        return view('global-altars.global-altars.index', [
    ...
    public function create()
    {
        ...
        return view('global-altars.global-altars.create', compact('statuses', 'logged_user', 'countries'));
    ...
    public function edit($id)
    {
        ...
        if ($user->hasRole('superadministrator')){
            ...
            return view('global-altars.global-altars.edit', compact('globalAltar', 'statuses'));
    ...
    public function show($id)
    {
        ...
        return view('global-altars.global-altars.show', compact('globalAltar'));
