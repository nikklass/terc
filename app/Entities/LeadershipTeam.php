...
class LeadershipTeam extends Model
{
    ...
    **/
    protected $fillable = [
         'id', 'first_name', 'last_name', 'title', 'description', 'email', 'phone', 'phone_country', 'country_id', 'state_id', 'status_id', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by' 
    ];
