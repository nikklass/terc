...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('prayer-requests') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.prayer-requests', 
                                                        ['xls', 
                                          ...
                                          <li><a href="{{ route('excel.prayer-requests', 'csv') }}">As CSV</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('prayer-requests.index') }}">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($prayerRequests as $prayerRequest)                                  
                                             <tr>
                                                ...
                                                <td>
                                                   <span>
                                                    @if ($prayerRequest->creator)
                                                      {{ $prayerRequest->creator->phone }} 
                                                    @endif
                                                   </span>
                                                </td>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('prayer-requests.show', $prayerRequest->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   <a href="{{ route('prayer-requests.edit', $prayerRequest->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i> 
                                                   </a>

                                                   <a href="{{ route('prayer-requests.destroy', $prayerRequest->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
