...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('state-representatives') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('state-representatives.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($stateRepresentatives as $stateRepresentative)                                  
                                             <tr>
                                                ...
                                                <td>                                                     
                                                  <span class="txt-dark">
                                                      {{ $stateRepresentative->first_name }} 
                                                      {{ $stateRepresentative->last_name }}
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('state-representatives.show', $stateRepresentative->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   <a href="{{ route('state-representatives.edit', $stateRepresentative->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i> 
                                                   </a>

                                                   <a href="{{ route('state-representatives.destroy', $stateRepresentative->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
