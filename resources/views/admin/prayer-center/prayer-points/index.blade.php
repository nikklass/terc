...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('prayer-points') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.prayer-points', 
                                                        ['xls', 
                                          ...
                                          <li><a href="{{ route('excel.prayer-points', 'csv') }}">As CSV</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('prayer-points.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($prayerPoints as $prayerPoint)                                  
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('prayer-points.show', $prayerPoint->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   <a href="{{ route('prayer-points.edit', $prayerPoint->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i> 
                                                   </a>

                                                   <a href="{{ route('prayer-points.destroy', $prayerPoint->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
