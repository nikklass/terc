    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Add New Prayer Request</h5>
          </div>
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('prayer-requests.create') !!}
          </div>
       </div>
       <!-- /Title -->
                        ...
                        <div class="panel panel-default card-view">
                           ...
                           <div class="panel-wrapper collapse in">
                              ...
                              <div class="panel-body">               
                                 ...
                                 <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">Add New Prayer Request</h3>
                                 </div>   
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST" 
                                        action="{{ route('prayer-requests.store') }}"> 
                                       ...
                                       <div  class="form-group{{ $errors->has('full_names') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            <input 
                                                ...
                                                id="full_names" 
                                                name="full_names"
                                                value="{{ $logged_user->first_name }} {{ $logged_user->last_name }}" required autofocus>
