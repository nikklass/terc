                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($countries as $country)                                  
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark @if (($country->status) && (($country->status->id == 2)
                                                         || ($country->status->id == 3)
                                                         || ($country->status->id == 7)
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('countries.show', $country->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   <a href="{{ route('countries.edit', $country->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
