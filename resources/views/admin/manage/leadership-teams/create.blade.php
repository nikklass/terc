    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Add New Leadership Team Member</h5>
          </div>
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('leadership-teams.create') !!}
          </div>
       </div>
       <!-- /Title -->
                        ...
                        <div class="panel panel-default card-view">
                           ...
                           <div class="panel-wrapper collapse in">
                              ...
                              <div class="panel-body">               
                                 ...
                                 <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">Add New Leadership Team Member</h3>
                                 </div>   
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST" 
                                        action="{{ route('leadership-teams.store') }}"> 
